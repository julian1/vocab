...
CONSTRAINT classification_scheme_association_table_fkey FOREIGN KEY (classification_scheme_category_id) REFERENCES contr_vocab_db.classification_scheme_category_table (classification_scheme_category_id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
CONSTRAINT classification_scheme_association_table_fkey2 FOREIGN KEY (classification_scheme_id) REFERENCES contr_vocab_db.classification_scheme_table (classification_scheme_id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION 
);
ALTER TABLE contr_vocab_db.classification_scheme_association_table 
  OWNER TO contr_vocab_db;
-----------------------------------------------------------------------------------------------------------------------------------------
-- Term category classification table
CREATE TABLE contr_vocab_db.term_category_classification_table 
(
classification_scheme_id integer,
classification_scheme_category_id integer,
vocabulary_term_name character varying (110),
...
CONSTRAINT term_category_classification_table_pkey PRIMARY KEY (classification_scheme_id,classification_scheme_category_id,vocabulary_term_name),
CONSTRAINT term_category_classification_table_fkey FOREIGN KEY (vocabulary_term_name) REFERENCES contr_vocab_db.vocabulary_term_table (vocabulary_term_name) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
CONSTRAINT term_category_classification_table_fkey2 FOREIGN KEY (classification_scheme_category_id) REFERENCES contr_vocab_db.classification_scheme_category_table (classification_scheme_category_id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
CONSTRAINT term_category_classification_table_fkey3 FOREIGN KEY (classification_scheme_id) REFERENCES contr_vocab_db.classification_scheme_table (classification_scheme_id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION 
);
ALTER TABLE contr_vocab_db.term_category_classification_table 
  OWNER TO contr_vocab_db;
-----------------------------------------------------------------------------------------------------------------------------------------
-- Amendment table
